    ...
    return(
        <div className="bg-gray-950">
            <div className="flex flex-col items-center">
                <h1 className="text-3xl pb-6">ROYALLA</h1>
                <p className="text-lg">Come and feel a New Vision Of Comfort.</p>
                <span className="text-lg">for more info follow us 
            ...
            <div className="mt-10 grid grid-cols-2 gap-8 mx-2 sm:mx-44 md:grid-cols-4 md:mx-10">
                <div>
